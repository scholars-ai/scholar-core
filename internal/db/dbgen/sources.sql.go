...
returning id, name, type, url, category, weight, enabled, fetch_config, created_at, updated_at
`
...
select s.id, s.name, s.type, s.url, s.category, s.weight, s.enabled, s.fetch_config, s.created_at, s.updated_at,
